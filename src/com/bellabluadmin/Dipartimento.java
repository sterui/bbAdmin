...
public class Dipartimento extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_dipartimento);
	...
	adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
	    ...
	    spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view,
				...
				dipartimento =  spinner.getSelectedItem().toString();
	...
	public void sendRequest(int mese)
	{
        ...
        HttpPost httppost = new HttpPost("http://bellablu.dx.am/sendDepartment.php");
      ...
      try{
            ...
            request+="Totale likes: "+sum+"\n";
            	...
            	for(int i=1;i<jArray.length();i++){
                   ...
                   request+= "Voto: "+ punteggio +" ricevuto alle: " + timestamp + "\n";
